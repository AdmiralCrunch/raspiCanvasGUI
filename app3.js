...
router.get('/', (req, res) => { res.sendFile(path.join(__dirname + '/templates/splashScreen.html')); });
router.get('/splashScreen', (req, res) => { res.sendFile(path.join(__dirname + '/templates/splashScreen.html')); });
